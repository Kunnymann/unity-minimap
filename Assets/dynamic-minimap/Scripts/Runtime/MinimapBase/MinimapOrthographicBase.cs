...
namespace minimap.runtime
{
    ...
    /// </summary>
    [CreateAssetMenu(fileName = "MinimapOrthographicBase", menuName = "MinimapCreator/MinimapOrthographicBase")]
    public class MinimapOrthographicBase : MinimapBase
    {
